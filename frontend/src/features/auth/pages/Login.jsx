...
const InputField = ({
  ...
  <div className="flex flex-col gap-1.5">
    <label
      htmlFor={id}
      className="text-xs font-semibold text-slate-500 uppercase tracking-widest ml-0.5"
    >
      {label}
    </label>
    ...
    <div className="relative z-10 flex flex-col items-center gap-10 px-12">
      ...
      <div className="flex flex-wrap justify-center gap-2">
        {[
          ...
          <div
            key={item.name}
            className={`flex items-center gap-2 px-3 py-1.5 rounded-full border text-xs font-medium ${item.color}`}
          >
      ...
      <div className="text-center max-w-xs">
        <p className="text-slate-400 text-sm leading-relaxed">
          Real-time object detection powered by YOLOv8. Items are recognised and
